...
| web-search | — | [agent-reach](web-search/agent-reach/SKILL.md) | 全网调研:13 平台多后端路由(小红书/推特/B站/Reddit/V2EX/LinkedIn/YouTube/GitHub 等) | [Panniantong/Agent-Reach](https://github.com/Panniantong/Agent-Reach) | — |
|  | — | [zhihu](web-search/zhihu/SKILL.md) | 知乎搜索/热榜/直答/创作管理 | — | 知乎官方分发([manifest](https://developer-cdn.zhihu.com/zhihu-cli/releases/stable/manifest.json)) |
| research | literature-management | [zotero](research/literature-management/zotero/SKILL.md) | Zotero 文献库管理:检索/元数据/全文/注释/引用 | — | [54yyyu/zotero-mcp](https://github.com/54yyyu/zotero-mcp)(v0.9.1) |
|  | scientific-figures | [academic-figures-drawer](research/scientific-figures/academic-figures-drawer/SKILL.md) | 科研绘图:论文配图、框架图、流程图(draw.io) | [M1n-n9/academic-figures-drawer](https://github.com/M1n-n9/academic-figures-drawer) | — |
